package app.quick_chat.managers;
...
public class DialogsManager {
    ...
    private QBChatDialog buildChatDialogFromSystemMessage(QBChatMessage qbChatMessage){
        ...
        Log.e(PROPERTY_OCCUPANTS_IDS,""+QbDialogUtils.getOccupantsIdsListFromString((String) qbChatMessage.getProperty(PROPERTY_OCCUPANTS_IDS)));
