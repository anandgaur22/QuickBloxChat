...
import app.quick_chat.ui.adapter.CheckboxUsersAdapter;
...
public class SelectUsersActivity extends BaseActivity {
     ...
     */
    public static void startForResult(AppCompatActivity activity, int code) {
        startForResult(activity, code, null);
    }

    public static void startForResult(AppCompatActivity activity, int code, QBChatDialog dialog) {
...
* */
        ...
        QBUsers.getUsers(pagedRequestBuilder, null).performAsync(new QBEntityCallback<ArrayList<QBUser>>() {
            @Override
